                ...
                <div className="m-5 flex flex-col items-center">
                  ...
                  <div className="flex flex-col gap-1 items-center">
                    ...
                    <button
                      ...
                      className="mt-2 p-4 py-3 bg-pink-200 w-full rounded text-sm font-medium active:bg-white border border-pink-200 "
                    >
                      GO TO HOME
                    </button>
                  </div>
              ...
              <>
                      ...
                      <div className="border border-gray-200 p-2 flex gap-2">
                        <div className="relative">
                          <input
                            type="checkbox"
                            checked={
                              itemsSelected && itemsSelected.includes(item)
                            }
                            onChange={(event) =>
                              handledSelectedItem(event, item)
                            }
                        ...
                        <div className="flex flex-col justify-between my-3">
                          ...
                          <div className="flex flex-col gap-1">
                            ...
                            <span className="font-semibold text-xs text-gray-400 text-ellipsis">
                              ...
                              adipisicing elit. Incidunt quod natus quo odio
                              quos maiores obcaecati sed deserunt, amet ullam
                              et! Distinctio mollitia aliquid eveniet dolorum
                              culpa ex quibusdam tempore.
                            </span>
                          </div>
                        </div>
                      </div>
                ...
                <div>
                  <span className="text-xs font-bold text-gray-500">
                    PRICE DETAILS ({itemsSelected && itemsSelected.length}{" "}
                    items)
                  </span>
                  ...
                  <div className="flex justify-center w-full m-3">
                    <button className="w-10/12 bg-pink-500 rounded text-white active:bg-white active:text-pink-500 p-4 border border-pink-500 font-bold">
                      PLACE ORDER
                    </button>
                  </div>
                </div>
